...
vastai create instance $(vastai search offers --on-demand 'gpu_name=RTX_3090 geolocation=US' --raw | jq -r 'min_by(.min_bid)' | jq -r .id) \
    --image jeremyadamsfisher1123/shakespeare-gpt:0.0.27 \
